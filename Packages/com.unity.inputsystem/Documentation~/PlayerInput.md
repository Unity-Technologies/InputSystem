...
| -- | -- | -- |
| **Send Messages** | Uses [`GameObject.SendMessage`](xref:UnityEngine.GameObject.SendMessage(System.String)) on the `GameObject` that the `PlayerInput` component belongs to. | [`SendMessages`](xref:UnityEngine.InputSystem.PlayerNotifications.SendMessages) |
| **Broadcast Messages** | Uses [`GameObject.BroadcastMessage`](xref:UnityEngine.GameObject.BroadcastMessage(System.String)) on the `GameObject` that the `PlayerInput` component belongs to. This broadcasts the message down the `GameObject` hierarchy. | [`BroadcastMessages`](xref:UnityEngine.InputSystem.PlayerNotifications.BroadcastMessages) |
