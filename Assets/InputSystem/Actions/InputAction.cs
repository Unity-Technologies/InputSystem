...
namespace ISX
{
    ...
    public class InputAction : ISerializationCallbackReceiver
    {
	    ...
	    public void Enable()
	    {
		    // The first time we enable a "lose" action, we create its hidden action set.
		    if (m_ActionSet == null)
		    {
			    m_PrivateActionSet = m_ActionSet = new InputActionSet();
	    ...
	    private InputActionSet m_ActionSet;
	    ...
	    private ReadOnlyArray<InputControl> m_Controls;
