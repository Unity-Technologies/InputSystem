...
To get started using this workflow, you need to [set up an Actions Asset as described in the previous workflow](Workflow-ActionsAsset.html). Then, rather than accessing your action values or assigning callbacks directly in your code, instead you make the connections between the actions and your code using the PlayerInput component UI. [Read more about using the PlayerInput component here](Components.html).
