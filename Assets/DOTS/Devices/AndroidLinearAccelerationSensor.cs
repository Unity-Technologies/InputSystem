...
//     version 1.1.0
//     from AndroidLinearAccelerationSensor Layout
//
...
{
    public struct AndroidLinearAccelerationSensorEvent : IInputData
    {
        public enum Id : uint
        {
            AccelerationX = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // AndroidLinearAccelerationSensorEvent -> AndroidLinearAccelerationSensorInput
                transforms[0] = new DOTSInput.InputTransform
                {
                    ...
                    OutputId = (uint)AndroidLinearAccelerationSensorInput.Id.AccelerationX
                };
                transforms[1] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.AccelerationY,
                    OutputId = (uint)AndroidLinearAccelerationSensorInput.Id.AccelerationY
                };
                transforms[2] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.AccelerationZ,
                    OutputId = (uint)AndroidLinearAccelerationSensorInput.Id.AccelerationZ
                };
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 3224042046,
                    OutputFormat = 2706076568,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<AndroidLinearAccelerationSensorEvent>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<AndroidLinearAccelerationSensorInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 3
                };

                // AndroidLinearAccelerationSensorEvent -> LinearAccelerationSensorInput
    ...
    public struct AndroidLinearAccelerationSensorInput : IComponentData, IInputData
    {
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 2706076568,
                    OutputFormat = 2706076568,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<AndroidLinearAccelerationSensorInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<AndroidLinearAccelerationSensorInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 1
                };
