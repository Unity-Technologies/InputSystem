...
{
    public struct MouseEvent : IInputData
    {
        public enum Id : uint
        {
            PositionX = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                {
                    InputFormat = 3291956319,
                    OutputFormat = 2773929465,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<MouseEvent>(),
        ...
        private const int kTransformCount = 21;
    }

    public struct MouseInput : IComponentData, IInputData
    {
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 2773929465,
                    OutputFormat = 2773929465,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<MouseInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<MouseInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 4
                };
