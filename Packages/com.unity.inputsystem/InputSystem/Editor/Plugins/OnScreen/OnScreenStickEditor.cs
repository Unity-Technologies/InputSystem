...
namespace UnityEditor.InputSystem.OnScreen
{
    ...
    internal class OnScreenStickEditor : UnityEditor.Editor
    {
        ...
        public void OnEnable()
        {
            ...
            m_UseIsolatedInputActions = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_UseIsolatedInputActions);
            m_Behaviour = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_Behaviour);
            m_ControlPathInternal = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_ControlPath);
            m_MovementRange = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_MovementRange);
            m_DynamicOriginRange = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_DynamicOriginRange);
            m_PointerDownAction = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_PointerDownAction);
            m_PointerMoveAction = serializedObject.FindProperty(OnScreenStick.OnScreenStickEditorHelper.m_PointerMoveAction);
        }
