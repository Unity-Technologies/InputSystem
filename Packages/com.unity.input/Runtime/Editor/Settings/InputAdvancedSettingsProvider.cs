...
namespace UnityEngine.InputSystem.Editor
{
    internal class InputAdvancedSettingsProvider : SettingsProvider, IDisposable
    {
        ...
        {
            return new InputAdvancedSettingsProvider(kSettingsPath, SettingsScope.Project);
        }

        private InputAdvancedSettingsProvider(string path, SettingsScope scopes)
            : base(path, scopes)
        {
            label = "Advanced";
            s_Instance = this;
        ...
        private static InputAdvancedSettingsProvider s_Instance;
