...
| -- | -- | -- |
| **Send Messages** | Uses [`GameObject.SendMessage`](UnityEngine.GameObject.SendMessage(System.String)) on the `GameObject` that the `PlayerInput` component belongs to. | [`SendMessages`](xref:UnityEngine.InputSystem.PlayerNotifications.SendMessages) |
