...
{
    public struct GravitySensorEvent : IInputData
    {
        public enum Id : uint
        {
            GravityX = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // GravitySensorEvent -> GravitySensorInput
                ...
                {
                    InputFormat = 4228334392,
                    OutputFormat = 2640759454,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<GravitySensorEvent>(),
    ...
    public struct GravitySensorInput : IComponentData, IInputData
    {
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 2640759454,
                    OutputFormat = 2640759454,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<GravitySensorInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<GravitySensorInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 1
                };
