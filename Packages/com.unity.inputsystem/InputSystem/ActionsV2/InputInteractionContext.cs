...
{
    public struct InputInteractionContext<TValue> where TValue : struct
    {
	    /// <summary>
        ...
        public InputInteractionContext(InputAction<TValue> action, InputControl<TValue> control, InputActionPhase phase, double time, double startTime,
        ...
        /// running, if any. However, some interactions (such as <see cref="MultiTapInteraction"/>)
