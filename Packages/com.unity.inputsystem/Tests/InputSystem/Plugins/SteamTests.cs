...
public class SteamTests : InputTestFixture
{
    ...
    public void Editor_CanGenerateInputDeviceBasedOnSteamIGAFile()
    {
        ...
        Assert.That(generatedCode, Contains.Substring("public override void ResolveActions(ISteamControllerAPI api)"));
        ...
        Assert.That(generatedCode, Contains.Substring("m_SetHandle_map1 = api.GetActionSetHandle(\"map1\");"));
        Assert.That(generatedCode, Contains.Substring("m_SetHandle_map2 = api.GetActionSetHandle(\"map2\");"));
        Assert.That(generatedCode, Contains.Substring("m_ActionHandle_buttonAction = api.GetDigitalActionHandle(\"buttonAction\");"));
    ...
    class TestController : SteamController
    {
        ...
        public ulong gameplaySetHandle;
        public ulong fireActionHandle;
        public ulong lookActionHandle;
    ...
    class TestSteamControllerAPI : ISteamControllerAPI
    {
        ...
        public Dictionary<string, ulong> sets =
            new Dictionary<string, ulong>
        {
            {"gameplay", 1}
        };
