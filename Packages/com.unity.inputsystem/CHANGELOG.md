...
- Updated the migration documentation to reflect that `Input.backButtonLeavesApp` is replaced by `Application.backButtonLeavesApp` in Unity 6.7 and later. [ISX-2229](https://jira.unity3d.com/browse/ISX-2229)
