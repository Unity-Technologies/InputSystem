...
//
//         public int nodeId => 0;
//         public string displayName => "Mux";
//         public int childCount => 2;
//         public IDependencyGraphNode GetChild(int index)
//         {
//             switch (index)
//             {
//                 case 0: return m_Source1;
//                 case 1: return m_Source2;
...
//         where T : struct
//     {
//         private Mux<T, IObservableInput<T>, Multiplexer<T>> m_Mux;
//         
//         public Multiplexer(IObservableInput<T> first, IObservableInput<T> second)
//         {
//             m_Mux = new Mux<T, IObservableInput<T>, Multiplexer<T>>(this, first, second);
//         }
//
