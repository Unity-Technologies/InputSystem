...
namespace UnityEngine.InputSystem.LowLevel
{
    ...
    public struct ScreenKeyboardEvent : IInputEventTypeInfo
    {
        ...
        internal ScreenKeyboardText GetComposition()
        {
            var nativeArray = GetCharacters();
            var str = new ScreenKeyboardText(nativeArray);
            nativeArray.Dispose();
            return str;
        }
    ...
    /// </remarks>
    [StructLayout(LayoutKind.Explicit, Size = sizeof(int) + sizeof(char) * LowLevel.ScreenKeyboardEvent.kIMECharBufferSize)]
    public unsafe struct ScreenKeyboardText : IEnumerable<char>
    {
        internal struct Enumerator : IEnumerator<char>
        {
            ScreenKeyboardText m_CompositionString;
            char m_CurrentCharacter;
            int m_CurrentIndex;

            public Enumerator(ScreenKeyboardText compositionString)
            {
        ...
        fixed char buffer[ScreenKeyboardEvent.kIMECharBufferSize];

        public ScreenKeyboardText(NativeArray<char> characters)
        {
            int copySize = ScreenKeyboardEvent.kIMECharBufferSize < characters.Length ? ScreenKeyboardEvent.kIMECharBufferSize : characters.Length;
            fixed (char* ptr = buffer)
            {
        ...
        public ScreenKeyboardText(string characters)
        {
            ...
            Debug.Assert(characters.Length < ScreenKeyboardEvent.kIMECharBufferSize);
