...
The UI Input Module passes actions from your Input System to your UI, as well as some other UI-related input settings. When working with Unity UI (uGUI), or when using UI Toolkit in versions of Unity prior to Unity 2023.2, you must use the **UI Input Module**. 
