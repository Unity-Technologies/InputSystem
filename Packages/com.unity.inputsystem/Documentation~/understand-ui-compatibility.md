...
The three main UI systems are **UI Toolkit**, **Unity UI**, and **IMGUI**. Some systems and versions require that you use the Input System’s [UI Input Module component](using-ui-input-module) to pass actions from the Input System to the UI. 
...
- In versions of Unity prior to 2023.2, you must use the [UI Input Module component](using-ui-input-module) to pass actions from the Input System to the UI.
