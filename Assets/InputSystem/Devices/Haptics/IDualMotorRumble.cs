namespace ISX.Haptics
{
    ...
    public interface IDualMotorRumble : IHaptics
    {
        ...
        /// Rumbling the motors at maximum speed may cause them to turn off for an unspecified to
        /// prevent overheating. Also, how quickly the motors react and how often the speed can
        /// be updated will depend on the hardware and drivers.
        /// </remarks>
