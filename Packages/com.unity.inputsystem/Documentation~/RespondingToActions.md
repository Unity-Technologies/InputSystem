...
For these methods, [ButtonControl.pressPoint](xref:UnityEngine.InputSystem.Controls.ButtonControl.pressPoint) (through [pressPointOrDefault](xref:UnityEngine.InputSystem.Controls.ButtonControl.pressPointOrDefault)) applies only when the bound control is a [ButtonControl](xref:UnityEngine.InputSystem.Controls.ButtonControl). For non-button controls (for example a stick as [StickControl](xref:UnityEngine.InputSystem.Controls.StickControl) or [Vector2Control](xref:UnityEngine.InputSystem.Controls.Vector2Control)), the press threshold is always [defaultButtonPressPoint](xref:UnityEngine.InputSystem.InputSettings.defaultButtonPressPoint) (typically `0.5`), regardless of interaction settings such as [PressInteraction.pressPoint](xref:UnityEngine.InputSystem.Interactions.PressInteraction.pressPoint). Those interaction parameters affect interaction-driven phases and callbacks, not this polling API.
