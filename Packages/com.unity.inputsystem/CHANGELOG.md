...
- Remediated majority of performance issues with high frequency mice (>=1kHz poll rates) in release mode by merging consecutive mouse move events together ([case 1281266](https://issuetracker.unity3d.com/issues/many-input-events-when-using-1000hz-mouse)), see the [documentation](Documentation~/Events.md#merging-of-events) for more information.
...
- Improved performance of `Touchscreen` by merging consecutive touch move events together. See the [documentation](Documentation~/Events.md#merging-of-events) for more information.
