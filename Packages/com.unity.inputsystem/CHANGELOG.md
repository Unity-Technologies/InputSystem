...
- Fixed the default button press point not being respected in Editor (as well as some other Touchsreen properties). [ISXB-1152](https://issuetracker.unity3d.com/product/unity/issues/guid/ISXB-1152)
