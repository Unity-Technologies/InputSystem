...
This page outlines the input device types and products that the Input System package supports, and the platforms they're supported on.

## Generic

Support for the following devices doesn't require specialized support of particular products.

|Device                 |Windows|macOS|Linux|UWP|Android|iOS|tvOS|WebGL|Xbox|PS4|Switch|
|-----------------------|-------|-----|-----|---|-------|---|----|-----|----|---|------|
|[Mouse](Mouse.md)      |Yes    |Yes  |Yes  |Yes|Yes    |No |No  |Yes  |Yes |Yes|No    |
|[Keyboard](Keyboard.md)|Yes    |Yes  |Yes  |Yes|Yes    |No |No  |Yes  |Yes |Yes|No    |
|[Pen](Pen.md)          |Yes    |Yes  |No   |Yes|Yes    |Yes|No  |No   |No  |No |No    |
|[Touchscreen](Touch.md)|Yes    |No   |No   |Yes|Yes    |Yes|Yes |Yes  |No  |No |No    |
|[Sensors](Sensors.md)  |No     |No   |No   |No |Yes    |Yes|No  |Yes  |No  |No |No    |
|[Joystick](#other-gamepads-joysticks-and-racing-wheels)|Yes|Yes |Yes  |Yes |Yes|No|No|Yes|No|No|No|
