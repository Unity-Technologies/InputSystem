...
namespace UnityEngine.InputSystem.Editor
{
    ...
    internal struct InputActionsEditorState
    {
        ...
        private InputActionAssetRequirementVerifier.Result m_VerificationResult;

        public InputActionAssetRequirementVerifier.Result verificationResult
        {
            get
            {
            ...
            InputActionAssetRequirementVerifier.Result verificationResult = null)
        {
            ...
            m_VerificationResult = verificationResult;
        ...
        public InputActionsEditorState(InputActionsEditorState other, SerializedObject asset)
        {
            ...
            m_VerificationResult = null; // invalidate
