...
namespace UnityEngine.InputSystem.OnScreen
{
    ...
    public class OnScreenStick : OnScreenControl, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        #if UNITY_EDITOR
        static internal class OnScreenStickEditorHelper {
            internal static string m_UseIsolatedInputActions = nameof(OnScreenStick.m_UseIsolatedInputActions);
            internal static string m_Behaviour = nameof(OnScreenStick.m_Behaviour);
            internal static string m_ControlPath = nameof(OnScreenStick.m_ControlPath);
            internal static string m_MovementRange = nameof(OnScreenStick.m_MovementRange);
            internal static string m_DynamicOriginRange = nameof(OnScreenStick.m_DynamicOriginRange);
            internal static string m_PointerDownAction = nameof(OnScreenStick.m_PointerDownAction);
            internal static string m_PointerMoveAction = nameof(OnScreenStick.m_PointerMoveAction);
        }
        #endif
