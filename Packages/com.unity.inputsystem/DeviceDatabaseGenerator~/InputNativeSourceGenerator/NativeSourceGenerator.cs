...
{
    internal static class NativeSourceGenerator
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //   new GeneratorBuilder().AddViaReflection().Build().GenerateNativeSourceCode());
          
            Parser.Default.ParseArguments<Options>(args).WithParsed<Options>(o =>
            {
                var code = new GeneratorBuilder().AddViaReflection().Build().GenerateNativeSourceCode();
                File.WriteAllText(o.Output, code);
            });
        }
    }
}