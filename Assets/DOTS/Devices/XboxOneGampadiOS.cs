...
{
    public struct XboxOneGampadiOSEvent : IInputData
    {
        public enum Id : uint
        {
            DpadUp = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // XboxOneGampadiOSEvent -> XboxOneGampadiOSInput
                ...
                transforms[14] = new DOTSInput.InputTransform
                {
                    ...
                    OutputId = (uint)XboxOneGampadiOSInput.Id.LeftStickX
                };
                transforms[15] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.LeftStickY,
                    OutputId = (uint)XboxOneGampadiOSInput.Id.LeftStickY
                };
                transforms[16] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.RightStickX,
                    OutputId = (uint)XboxOneGampadiOSInput.Id.RightStickX
                };
                transforms[17] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.RightStickY,
                    OutputId = (uint)XboxOneGampadiOSInput.Id.RightStickY
                };
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 1045113111,
                    OutputFormat = 1596629169,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<XboxOneGampadiOSEvent>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<XboxOneGampadiOSInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 18
                };

                // XboxOneGampadiOSEvent -> XInputControllerInput
                ...
                // XboxOneGampadiOSEvent -> GamepadInput
    ...
    public struct XboxOneGampadiOSInput : IComponentData, IInputData
    {
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 1596629169,
                    OutputFormat = 1596629169,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<XboxOneGampadiOSInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<XboxOneGampadiOSInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 19
                };
