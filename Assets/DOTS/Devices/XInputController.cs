...
{
    public struct XInputControllerEvent : IInputData
    {
        public enum Id : uint
        {
            DpadUp = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // XInputControllerEvent -> XInputControllerInput
    ...
    public struct XInputControllerInput : IComponentData, IInputData
    {
        ...
        public enum Id : uint
        {
            ...
            LeftShoulder = 736,
            RightShoulder = 744,
            ButtonLeftTrigger = 752,
            ButtonRightTrigger = 760,
            Start = 768,
            Select = 776,
            LeftStickPress = 784,
            RightStickPress = 792,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 3926081804,
                    OutputFormat = 3926081804,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<XInputControllerInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<XInputControllerInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 19
                };
