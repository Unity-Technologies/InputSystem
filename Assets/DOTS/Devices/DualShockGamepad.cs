...
{
    public struct DualShockGamepadEvent : IInputData
    {
        public enum Id : uint
        {
            DpadUp = 0,
        ...
        public unsafe bool TouchpadButton
        {
            ...
            {
                fixed(void* thisPtr = &this)
                return (((byte*)thisPtr)[28] & ((1 << 0) & 0xFF)) != 0;
            }
            set
            {
                fixed(void* thisPtr = &this)
                if (value)
                    ((byte*)thisPtr)[28] |= (1 << 0) & 0xFF;
                else
                    ((byte*)thisPtr)[28] &= ~(1 << 0) & 0xFF;
            }
        }

        public uint Format => 764352767;
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // DualShockGamepadEvent -> DualShockGamepadInput
                ...
                {
                    InputFormat = 764352767,
                    OutputFormat = 1290703193,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<DualShockGamepadEvent>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<DualShockGamepadInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 19
                };

                // DualShockGamepadEvent -> GamepadInput
    ...
    public struct DualShockGamepadInput : IComponentData, IInputData
    {
        ...
        public enum Id : uint
        {
            ...
            LeftShoulder = 760,
            RightShoulder = 768,
            ButtonLeftTrigger = 776,
            ButtonRightTrigger = 784,
            LeftStickPress = 792,
            RightStickPress = 800,
            DpadUp = 808,
            DpadDown = 816,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 1290703193,
                    OutputFormat = 1290703193,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<DualShockGamepadInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<DualShockGamepadInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 19
                };
