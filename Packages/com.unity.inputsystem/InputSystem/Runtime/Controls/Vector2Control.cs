...
namespace UnityEngine.InputSystem.Controls
{
    ...
    public class Vector2Control : InputControl<Vector2>, IActuationPressPoint
    {
        ...
        internal float IActuationPressPoint.pressPoint => pressPoint;
        ...
        /// </summary>
        public float pressPointOrDefault => pressPoint > 0.0f ? pressPoint : ButtonControl.s_GlobalDefaultButtonPressPoint;
