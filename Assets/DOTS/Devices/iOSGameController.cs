...
{
    public struct iOSGameControllerEvent : IInputData
    {
        public enum Id : uint
        {
            DpadUp = 0,
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                // iOSGameControllerEvent -> iOSGameControllerInput
                ...
                transforms[14] = new DOTSInput.InputTransform
                {
                    ...
                    OutputId = (uint)iOSGameControllerInput.Id.LeftStickX
                };
                transforms[15] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.LeftStickY,
                    OutputId = (uint)iOSGameControllerInput.Id.LeftStickY
                };
                transforms[16] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.RightStickX,
                    OutputId = (uint)iOSGameControllerInput.Id.RightStickX
                };
                transforms[17] = new DOTSInput.InputTransform
                {
                    Operation = DOTSInput.ToTransformOperation(DOTSInput.Conversion.FloatToAxis),
                    InputId1 = (uint)Id.RightStickY,
                    OutputId = (uint)iOSGameControllerInput.Id.RightStickY
                };
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 2186259560,
                    OutputFormat = 3811452366,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<iOSGameControllerEvent>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<iOSGameControllerInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 18
                };

                // iOSGameControllerEvent -> GamepadInput
    ...
    public struct iOSGameControllerInput : IComponentData, IInputData
    {
        ...
        public DOTSInput.InputPipeline InputPipelineParts
        {
            get
            {
                ...
                structMappings[0] = new DOTSInput.InputStructMapping
                {
                    InputFormat = 3811452366,
                    OutputFormat = 3811452366,
                    InputSizeInBytes = (uint)UnsafeUtility.SizeOf<iOSGameControllerInput>(),
                    OutputSizeInBytes = (uint)UnsafeUtility.SizeOf<iOSGameControllerInput>(),
                    TransformStartIndex = 0,
                    TransformCount = 19
                };
