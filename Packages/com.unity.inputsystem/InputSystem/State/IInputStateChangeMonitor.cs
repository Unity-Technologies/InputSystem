...
namespace UnityEngine.InputSystem.LowLevel
{
    ...
    /// </summary>
    /// <remarks>
    /// Use <see cref="InputState.AddChangeMonitor(InputControl,IInputStateChangeMonitor,long,int)"/> to install a state change monitor receiving state change
    /// callbacks for a specific control.
    /// </remarks>
    /// <seealso cref="InputState.AddChangeMonitor(InputControl,IInputStateChangeMonitor,long,int)"/>
