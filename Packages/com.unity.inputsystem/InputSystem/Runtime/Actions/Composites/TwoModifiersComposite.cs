...
namespace UnityEngine.InputSystem.Composites
{
    ...
    public class TwoModifiersComposite : InputBindingComposite
    {
        ...
        /// </summary>
        /// <remarks>
        /// By default, if the setting <see cref="InputSettings.IsShortcutComplexityModifierOrderActive"/> is enabled,
        ...
        public enum ModifiersOrder
        {
            ...
            /// before pressing the <c>B</c> key. This is the behavior usually expected with keyboard shortcuts.
            ///
            /// If the setting <see cref="InputSettings.IsShortcutComplexityModifierOrderActive"/> is disabled,
